  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
        <span className="inline-block text-xs font-semibold px-2.5 py-0.5 rounded-full mb-2 bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">
          {leader.state}
        </span>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-[#051336] overflow-hidden">
        ...
        >
          <span className="inline-block bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full mb-6">
            Nigeria Democratic Congress · Zamfara State
          </span>
          ...
          <p className="text-lg md:text-xl text-white/75 leading-relaxed max-w-2xl mx-auto">
            Meet the dedicated officers driving the NDC's vision across Zamfara State's 14 Local
            Government Areas — committed to democratic governance and the prosperity of all Zamfarawa.
          </p>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <p className="text-muted-foreground text-lg leading-relaxed">
              The NDC Zamfara State leadership is built on the foundation of integrity, unity, and
              service — reflecting our commitment to inclusive, transparent party governance at every
              level.
            </p>
          </motion.div>
        </div>
